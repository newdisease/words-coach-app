...
export const AddDictionaryIcon = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const CorrectIcon = () => {
  return (
    ...
    >
      <path
        d="M77.7124 10.9367C76.5355 9.75781 74.626 9.75578 73.4491 10.9317L37.2783 47.007L24.228 32.8331C23.1004 31.6091 21.1938 31.5297 19.9677 32.6572C18.7426 33.7848 18.6641 35.6923 19.7918 36.9175L34.9677 53.3989C35.5235 54.003 36.3013 54.3537 37.1215 54.3708C37.1435 54.3717 37.1648 54.3717 37.1858 54.3717C37.9829 54.3717 38.7496 54.0552 39.3144 53.4923L77.7065 15.2009C78.8863 14.0252 78.8883 12.1156 77.7124 10.9367Z"
        fill="white"
      />
      <path
        d="M76.9848 36.9848C75.3195 36.9848 73.9698 38.3345 73.9698 40C73.9698 58.7317 58.7317 73.9698 40 73.9698C21.2694 73.9698 6.03016 58.7317 6.03016 40C6.03016 21.2694 21.2694 6.03016 40 6.03016C41.6653 6.03016 43.0152 4.68047 43.0152 3.01516C43.0152 1.34969 41.6653 0 40 0C17.9437 0 0 17.9437 0 40C0 62.0553 17.9437 80 40 80C62.0553 80 80 62.0553 80 40C80 38.3347 78.6503 36.9848 76.9848 36.9848Z"
        fill="white"
      />
    </svg>
  );
...
export const WrongIcon = () => {
  return (
    ...
    >
      <path
        d="M40 0C17.9437 0 0 17.9437 0 40C0 62.0563 17.9437 80 40 80C62.0563 80 80 62.0563 80 40C80 17.9437 62.0563 0 40 0ZM40 74.1747C21.1562 74.1747 5.82531 58.8438 5.82531 40C5.82531 21.1562 21.1562 5.82531 40 5.82531C58.8438 5.82531 74.1747 21.1562 74.1747 40C74.1747 58.8438 58.8438 74.1747 40 74.1747Z"
        fill="white"
      />
      <path
        d="M63.4737 12.5005L12.405 63.5691L16.5233 67.6874L67.592 16.6188L63.4737 12.5005Z"
        fill="white"
      />
    </svg>
  );
